...
class AirbnbNightlyPriceDataset(Dataset):
    def __init__(self):
        ...
        self.X, self.y = load_airbnb(df,"Price_Night")
...
def save_model(model, optimiser, optimiser_parameters, performance_metrics ):
    ...
    nn = '/Users/angelicaaluo/Airbnb/AIRBNB-DATASET/Pytorch/NeuralNetwork/'
    ...
    # if not os.path.isfile(optimiser_path):
...
def train(model,optimiser_class, learning_rate, dataloader, epochs):
    ...
    # save_model(model, optimiser,optimiser_parameters, eval_metrics)
